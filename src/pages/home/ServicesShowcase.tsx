...
export const ServicesShowcase: React.FC<ServicesShowcaseProps> = ({
  ...
  const services = [
    ...
    {
      id: 'tension-bands',
      title: 'CHAIN LINK TENSION BANDS',
      image: IMAGES.tensionBandObj,
      icon: Layers,
      category: 'Commercial Hardware',
      desc: 'Heavy-gauge hot-dip galvanized tension bands, brace bands, and post clamps to ASTM F626.',
    },
    {
    ...
    },
    {
      ...
      title: 'CHAIN LINK POST FITTINGS',
      image: IMAGES.fenceFittings,
      icon: Drill,
      category: 'Commercial Fittings',
      desc: 'Hot-dip galvanized post caps, loop caps, rail ends, and terminal sleeve fittings.',
    },
    {
      id: 'gate-hardware-catalog',
      title: 'COMMERCIAL GATE HARDWARE',
      image: IMAGES.hardwareCatalog,
      icon: Hammer,
      category: 'Access Hardware',
      desc: 'Industrial cane bolts, drop rods, locking latches, and heavy-duty gate stop assemblies.',
    },
  ];
